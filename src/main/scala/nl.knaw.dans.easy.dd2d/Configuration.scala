...
object Configuration {
  ...
  def apply(home: File): Configuration = {
    ...
    val licenseUriVariantsFile = findFileInInstall("license-uri-variants.csv")
    val supportedLicensesFile = findFileInInstall("supported-licenses.txt")
    ...
    new Configuration(
      ...
      supportedLicenses = loadTxtToList(supportedLicensesFile).get
    )
  }
